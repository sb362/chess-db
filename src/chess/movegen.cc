...
#define BENCHMARK(name, depth, fen, nodes)                                 \
  TEST_CASE(name) {                                                        \
    const auto pos = *Position::from_fen(fen);                             \
    b.batch(nodes); b.unit("nodes");                                       \
...
TEST_SUITE("bench-perft") {
  ...
  BENCHMARK("Startpos",   5, "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq -", 4865609);
  BENCHMARK("Kiwipete",   4, "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", 4085603);
  BENCHMARK("CPW #3",     5, "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", 674624);
  BENCHMARK("CPW #4A",    4, "r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq -", 422333);
  BENCHMARK("CPW #4B",    4, "r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ -", 422333);
  BENCHMARK("CPW #5",     4, "rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ -", 2103487);
  BENCHMARK("CPW #6",     4, "r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - -", 3894594);
  BENCHMARK("Promotions", 5, "n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - -", 3605103);
}
#undef BENCHMARK
