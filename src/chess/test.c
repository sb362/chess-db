...
struct UnitTest tests[] = {
	...
	{ .name = "position 4a", .fen = "r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1",
	  .depth = 6, .result = 706045033 },

	{ .name = "position 4b", .fen = "r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1",
	  .depth = 6, .result = 706045033 },
